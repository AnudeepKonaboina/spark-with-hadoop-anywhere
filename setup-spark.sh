...
if [ "$BUILD_MODE" = true ]; then
  echo ""
  echo "****This setup would take around 10-15 minutes...just grab a coffee or tea and relax!!!****"
  ...
  echo "****This setup would take around 5-7 minutes...just grab a coffee or tea and relax!!!****"
