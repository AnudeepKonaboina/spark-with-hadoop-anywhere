...
[![Scala](https://img.shields.io/badge/Scala-2.12.17-DC322F?logo=scala&logoColor=white)](https://www.scala-lang.org/download/2.12.17.html)
...
#### 1. Clone the project and navigate to the main directory using the command below
   ```commandline
   git clone -b spark-3.4.1 https://github.com/AnudeepKonaboina/spark-with-hadoop-anywhere.git && cd spark-with-hadoop-anywhere/
   ```
...
2025-11-15 14:14:33,119 INFO repl.Main: Created Spark session
Spark context Web UI available at http://hadoop.spark:4040
Spark context available as 'sc' (master = local[*], app id = local-1763216072955).
