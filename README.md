...
[![Scala](https://img.shields.io/badge/Scala-2.13.8-DC322F?logo=scala&logoColor=white)](https://www.scala-lang.org/download/2.13.8.html)
...
#### To run hive inside container use beeline:
```commandline
[root@hadoop /]# beeline -u jdbc:hive2://localhost:10000
SLF4J: Class path contains multiple SLF4J bindings.
SLF4J: Found binding in [jar:file:/usr/bin/apache-hive-4.0.0-bin/lib/log4j-slf4j-impl-2.18.0.jar!/org/slf4j/impl/StaticLoggerBinder.class]
...
25/11/17 14:50:34 WARN NativeCodeLoader: Unable to load native-hadoop library for your platform... using builtin-java classes where applicable
Spark context Web UI available at http://hadoop.spark:4040
Spark context available as 'sc' (master = local[*], app id = app-20251117145035-0000).
...
Spark context Web UI available at http://hadoop.spark:4040
Spark context available as 'sc' (master = spark://hadoop.spark:7077, app id = app-20251115150403-0000).
Spark session available as 'spark'.
Welcome to
      ____              __
     / __/__  ___ _____/ /__
...
Using Scala version 2.13.14 (OpenJDK 64-Bit Server VM, Java 1.8.0_412)
Type in expressions to have them evaluated.
Type :help for more information.
