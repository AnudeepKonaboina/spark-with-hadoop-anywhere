...
[![Scala](https://img.shields.io/badge/Scala-2.13.16-DC322F?logo=scala&logoColor=white)](https://www.scala-lang.org/download/2.13.14.html)
...
#### 1. Clone the project and navigate to the main directory using the command below
   ```commandline
   git clone -b spark-4.0.0 https://github.com/AnudeepKonaboina/spark-with-hadoop-anywhere.git && cd spark-with-hadoop-anywhere/
   ```
...
CONTAINER ID   IMAGE                                                               COMMAND                   CREATED         STATUS         PORTS                                                                                                                                                                                                                                                                                                NAMES
60e52fdc6bc5   docker4ops/spark-with-hadoop:spark-4.0.0_hadoop-3.4.1_hive-4.0.1   "bash -lc '\n  ${SPAR…"   6 minutes ago   Up 6 minutes                                                                                                                                                                                                                                                                                                        spark-worker-2
973ee17a76e8   docker4ops/spark-with-hadoop:spark-4.0.0_hadoop-3.4.1_hive-4.0.1   "bash -lc '\n  ${SPAR…"   6 minutes ago   Up 6 minutes                                                                                                                                                                                                                                                                                                        spark-worker-1
18bd26ade9ac   docker4ops/spark-with-hadoop:spark-4.0.0_hadoop-3.4.1_hive-4.0.1   "bash -lc '\n  /usr/l…"   6 minutes ago   Up 6 minutes   0.0.0.0:4040-4041->4040-4041/tcp, [::]:4040-4041->4040-4041/tcp, 0.0.0.0:7077->7077/tcp, [::]:7077->7077/tcp, 0.0.0.0:8080->8080/tcp, [::]:8080->8080/tcp, 0.0.0.0:50070->50070/tcp, [::]:50070->50070/tcp, 0.0.0.0:2222->22/tcp, [::]:2222->22/tcp, 0.0.0.0:8090->18080/tcp, [::]:8090->18080/tcp   spark-master
12fcb76b3af2   docker4ops/hive-metastore:hive-4.0.1                                "docker-entrypoint.s…"    6 minutes ago   Up 6 minutes   5432/tcp                                                                                                                                                                                                                                                                                             hive_metastore
```

#### 5. Connect to containers using the below command to run services
...
Spark context available as 'sc' (master = local[*], app id = local-1763436454756).
...
Type :help for more information.
Spark context Web UI available at http://hadoop.spark:4040
Spark context available as 'sc' (master = spark://hadoop.spark:7077, app id = app-1763436454756).
Spark session available as 'spark
...
SLF4J: Found binding in [jar:file:/usr/bin/apache-hive-4.0.1-bin/lib/log4j-slf4j-impl-2.18.0.jar!/org/slf4j/impl/StaticLoggerBinder.class]
SLF4J: Found binding in [jar:file:/usr/bin/hadoop-3.4.1/share/hadoop/common/lib/slf4j-reload4j-1.7.36.jar!/org/slf4j/impl/StaticLoggerBinder.class]
